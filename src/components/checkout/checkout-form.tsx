...
export function CheckoutForm() {
  ...
  const [values, setValues] = useState<CheckoutValues>(emptyValues); const [errors, setErrors] = useState<FieldErrors>({});
